 ...
 * applications has been received. See under \ss_servicediscovery_link.
 */
 ...
 * the \ss_runtime_link{getEntitlementVersionsFor:callbackBlock:} \ss_function,
 ...
 *
 * The BlackBerry Dynamics runtime sets this property to \ss_false when the
 * application starts.
 * 
 * The BlackBerry Dynamics runtime sets this property to \ss_true when
 ...
 *
 * The BlackBerry Dynamics runtime sets this property to \ss_false if the end
 ...
 * .
 *
 * If this property has the value \ss_true, then the prinicipal programming
 ...
 *
 * @see \ss_runtime_link for more details on authorization processing and
 * states.
 */
 ...
 * authorized, i.e. when the \ref isAuthorized property is \ss_false. The value
